 ...
 */
public class GridDeleteLayers extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                         ...
                         //       Intent intent = new Intent(GridDeleteLayers.this, menu.class);
                         //       GridDeleteLayers.this.startActivity(intent);
                         //   } else if (drawerItem.getIdentifier() == 2) {
                                Intent intent = new Intent(GridDeleteLayers.this, BackUpRestore.class);
                                GridDeleteLayers.this.startActivity(intent);
                         //   } else if (drawerItem.getIdentifier() == 3) {
                          //      Intent intent = new Intent(GridDeleteLayers.this, DeleteLayers.class);
                          //      GridDeleteLayers.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 4) {
                                Intent intent = new Intent(GridDeleteLayers.this, About.class);
                                GridDeleteLayers.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 5) {
                                Intent intent = new Intent(GridDeleteLayers.this, ChangeLog.class);
                                GridDeleteLayers.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 6) {
                                Intent intent = new Intent(GridDeleteLayers.this, Instructions.class);
                                GridDeleteLayers.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 7) {
                                Intent intent = new Intent(GridDeleteLayers.this, Settings.class);
                                GridDeleteLayers.this.startActivity(intent);
        ...
        CustomGridAdapter adapter = new CustomGridAdapter(GridDeleteLayers.this, title, subTitle, imageId);
        ...
        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {  // LAUNCH DELETE CHOOSER
    ...
    // COMMAND 1 DELETE SELECTED FILEs
    public void deletemultiplecommand() {
        ...
        if (paths != null) {
            ...
            Toast.makeText(GridDeleteLayers.this, "DELETED SELECTED LAYERS", Toast.LENGTH_LONG).show();

        } else {

            Toast.makeText(GridDeleteLayers.this, "NOTHING TO DELETE", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void deleteallcommand() {
        ...
        try {
            ...
            Toast.makeText(GridDeleteLayers.this, "DELETED ALL LAYERS", Toast.LENGTH_LONG).show();
