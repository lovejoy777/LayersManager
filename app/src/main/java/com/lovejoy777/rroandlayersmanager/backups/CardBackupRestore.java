 ...
 */
public class CardBackupRestore extends ActionBarActivity {
    static final String TAG = "CardBackupRestore";
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            if (drawerItem.getIdentifier() == 1) {
                                ...
                                Intent intent = new Intent(CardBackupRestore.this, About.class);
                                CardBackupRestore.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 5) {
                                Intent intent = new Intent(CardBackupRestore.this, ChangeLog.class);
                                CardBackupRestore.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 6) {
                                Intent intent = new Intent(CardBackupRestore.this, Instructions.class);
                                CardBackupRestore.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 7) {
                                Intent intent = new Intent(CardBackupRestore.this, Settings.class);
                                CardBackupRestore.this.startActivity(intent);
        ...
        int listImages[] = new int[]{R.drawable.player, R.drawable.books,
                R.drawable.sync, R.drawable.power};
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                // Add Header to card
               // header.setTitle("BackUp");
                card.setTitle("BACKUP\n \nAll Installed Layers");
            ...
            if (i == 2) {
                // Add Header to card
               // header.setTitle("Restore");
                card.setTitle("RESTORE\n \nSelected Backup");
               // card.addCardHeader(header);
            ...
            card.setOnClickListener(new Card.OnCardClickListener() {
                ...
                public void onClick(Card card, View view) {
                    ...
                    if (finalI == 0) {
                        ...
                        final AlertDialog.Builder alert = new AlertDialog.Builder(CardBackupRestore.this);
                        final EditText input = new EditText(CardBackupRestore.this);
                        ...
                        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                if (backupname.length() <= 1) {
                                    ...
                                    Toast.makeText(CardBackupRestore.this, "INPUT A NAME", Toast.LENGTH_LONG).show();
                                    ...
                                    if (contents.length == 0) {
                                        ...
                                        Toast.makeText(CardBackupRestore.this, "NOTHING TO BACKUP", Toast.LENGTH_LONG).show();
                                    ...
                                    // Folder contains files
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(CardBackupRestore.this, "BACKUP COMPLETED", Toast.LENGTH_LONG).show();
    ...
    public void restore() {
        ...
        if (SZP != null) {
            ...
            try {
                ...
                Toast.makeText(CardBackupRestore.this, "RESTORE COMPLETED", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(CardBackupRestore.this, "SELECT A BACKUP TO RESTORE", Toast.LENGTH_LONG).show();
    ...
    public void reboot() {
        ...
        try {
            ...
            Toast.makeText(CardBackupRestore.this, "Rebooting", Toast.LENGTH_LONG).show();
            // MK DIR /SDCARD/OVERLAYS/BACKUP/TEMP
