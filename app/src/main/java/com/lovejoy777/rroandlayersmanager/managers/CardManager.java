...
public class CardManager extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            if (drawerItem.getIdentifier() == 1) {
                                Intent intent = new Intent(CardManager.this, menu.class);
                                CardManager.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 2) {
                                Intent intent = new Intent(CardManager.this, BackUpRestore.class);
                                CardManager.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 3) {
                                Intent intent = new Intent(CardManager.this, DeleteLayers.class);
                                CardManager.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 4) {
                                Intent intent = new Intent(CardManager.this, About.class);
                                CardManager.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 5) {
                                Intent intent = new Intent(CardManager.this, ChangeLog.class);
                                CardManager.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 6) {
                                Intent intent = new Intent(CardManager.this, Instructions.class);
                                CardManager.this.startActivity(intent);
                            } else if (drawerItem.getIdentifier() == 7) {
                                Intent intent = new Intent(CardManager.this, Settings.class);
                                CardManager.this.startActivity(intent);
        ...
        int listImages[] = new int[]{R.drawable.books, R.drawable.add,
                R.drawable.chart, R.drawable.power};
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
              ...
              //  header.setTitle("File Chooser");
               ...
               // card.addCardHeader(header);
                card.changeBackgroundResourceId(0x000);

            }

            if (i == 1) {
                // Add Header to card
               // header.setTitle("Install");

                card.setTitle("INSTALL\n \nYour Chosen Layer");
               // card.addCardHeader(header);
            ...
            if (i == 2) {
                // Add Header to card
               // header.setTitle("Installed Layers");
                card.setTitle("Installed\n \nCheck Whats Already Installed");
              //  card.addCardHeader(header);
    ...
    public void rebootcommand() {
        ...
        try {
            ...
            Toast.makeText(CardManager.this, "Rebooting", Toast.LENGTH_LONG).show();
    ...
    public void installcommand() {
        ...
        if (extras != null) {
            ...
            if (SZP.length() <= 1) {
                ...
                Toast.makeText(CardManager.this, "CHOOSE A FILE", Toast.LENGTH_LONG).show();
